...
contextEvents:
  - label: "Japanese attack on the Philippines"
    layer: world
    thread: "Occupation and survival"
    importance: major
    year: 1941
    place: "Philippines"
    note: "The invasion pushed Orosa's food chemistry into wartime resistance and survival work."
    status: reviewed
